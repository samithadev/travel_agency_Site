    ...
    <div className="bg-main text-white">
      <div className="flex flex-col md:flex-row justify-between p-8 md:px-32 px-5">
        <div className=" w-full md:w-1/4">
          <h1 className=" font-semibold text-xl pb-4">TravelMe</h1>
          <p className=" text-sm">
            With TravelMe you can experience new travel and the best tourist
      ...
      <div>
        <p>
          <p className=" text-center py-4">
            ...
            <span className=" text-brightColor">Samitha Wickramasinghe</span> | All
            rights reserved
          </p>
        </p>
      </div>
